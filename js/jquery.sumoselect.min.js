          ...
          (this.sumo = {
            ...
            multiSelelect: function multiSelelect() {
              ...
              b.optDiv.addClass("multiple"),
                (b.okbtn = a('<p tabindex="0" class="btnOk"></p>').on(
                  "click",
                  function () {
                    b._okbtn(), b.hideOpts();
                  }
              ...
              (b.okbtn[0].innerText = c[0]),
                (b.cancelBtn = a('<p tabindex="0" class="btnCancel"></p>').on(
                  "click",
                  function () {
                    b._cnbtn(), b.hideOpts();
                  }
            ...
            showOpts: function showOpts() {
              ...
              if (!b.E.attr("disabled")) {
                b.E.trigger("sumo:opening", b),
                  (b.is_opened = !0),
                  b.select.addClass("open").attr("aria-expanded", "true"); // Scroll first selected option into view
                var c = b.optDiv.find("li.opt.selected").first();
                if (
                  (c.length
                    ? b.optDiv.find(".options").scrollTop(c.position().top)
                    : b.optDiv.find(".options").scrollTop(0),
                  ...
                  b.is_multi && (d += +b.optDiv.css("padding-bottom")),
                    b.optDiv.css("height", d),
            ...
            hideOpts: function hideOpts() {
              ...
              b.is_opened &&
                ...
                f.search && (b.ftxt.val(""), b.ftxt.trigger("input.sumo")));
            },
            ...
            basicEvents: function basicEvents() {
              var b = this;
              b.CaptionCont.on("click", function (a) {
                b.E.trigger("click"),
                  ...
                  switch (a.which) {
                    ...
                    case 13:
                      b.is_opened &&
                        ...
                        f.search ? b.select.focus() : b.setOnOpen();
                      break;
                    case 9:
                      return void (f.okCancelInMulti || b.hideOpts());
                    case 27:
                      return (
                        f.okCancelInMulti && b._cnbtn(),
                        b.hideOpts(),
                        void (f.search && b.select.focus())
                      );
                    default:
